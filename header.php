        ...
        <div class="header-content">
            ...
            <div class="site-logo">
                <a href="<?php echo esc_url(home_url('/')); ?>">
                    <img src="<?php echo get_template_directory_uri(); ?>/Assets/logoViolet.png" alt="<?php bloginfo('name'); ?>">
                </a>
            </div>
...
<?php if (!$is_logged_in): ?>
    ...
    <div id="popupConnexion" class="popup-overlay">
        <div class="popup-content">
            ...
            <!-- Logo -->
            <img src="<?php echo get_template_directory_uri(); ?>/Assets/logoViolet.png" class="logo-popup" alt="Logo">
